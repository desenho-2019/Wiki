...
| US04 | Usuário | Acessar dados do perfil | Visualizar e alterar os dados pessoais (Nome, sexo, whatsapp/telefone, data de nascimento, foto de perfil, redes sociais, nacionalidade) | Must | |
...
| US07 | Usuário | Deslogar da minha conta | Acessar o aplicativo com outra conta existente ou criar uma nova | Must | |
...
| ID | Eu, como | Gostaria de | Para poder | Priorização | Pontuação |
| :---: | :---: | :---: | :---: | :---: | :---: |
| US33 | Visitante/Usuário | Me cadastrar na aplicação | Ter acesso às funcionalidades do Cafofo | Must | |
...
| US36 | Usuário | Realizar o login na aplicação | Acessar os recursos da aplicação | Must | |
