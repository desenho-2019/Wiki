...
| ID | Eu, como | Gostaria de | Para poder | Priorização | Pontuação |
| :---: | :---: | :---: | :---: | :---: | :---: |
| US33 | Visitante/Usuário | Me cadastrar na aplicação | Ter acesso às funcionalidades do Cafofo | Must | 3 |
...
| US36 | Usuário | Realizar o login na aplicação | Acessar os recursos da aplicação | Must | 2 |
